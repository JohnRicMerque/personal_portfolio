...
const EmailSection = () => {
  return (
    <section id="contact" className='grid md:grid-cols-2 md:my-12 py-24 gap-2 relative lg:px-14 px-4'>
      <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-green-900 to-transparent rounded-full h-80 w-80 z-0 blur-lg absolute top-2/4 -left-4 transform -translate-x-1/2 -translate-1/2"></div>
      <div className='z-10'>
